...
namespace _2312805_TranNgocNhuY_lab07.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void CheckoutTable(int tableId)
        {
            ...
            var bill = _context.Bills.FirstOrDefault(b => b.Table01 != null && b.Table01.Name == table.Name && !b.Status);
        ...
        private void LoadBillDetails(int tableId)
        {
            ...
            var table = _context.Tables.FirstOrDefault(t => t.Id == tableId);
            var bill = _context.Bills.FirstOrDefault(b => b.Table01.Name == table.Name && !b.Status);
        ...
        private void AddFoodToBill(int tableId, int foodId, int quantity)
        {
            ...
            if (bill == null)
            {
                ...
                {
                    Table01 = table,
                    Name = $"Hóa đơn cho {table.Name}", 
                    Amount = 0,
                    Status = false,
                    CheckoutDate = DateTime.Now,
                    Account = _loggedInAccount.AccountName 
                };
        ...
        private void btnPrintBill_Click(object sender, EventArgs e)
        {
           ...
           Bills bill = _context.Bills.FirstOrDefault(b => b.Table01.Name == table.Name && b.Status);
            if (bill == null)
            {
